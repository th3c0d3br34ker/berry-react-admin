        ...
        <Switch location={location} key={location.pathname}>
          <AuthGuard>
            ...
            <Route
              ...
              component={AppUserSocialProfile}
            />
            <Route
              path="/user/account-profile/profile1"
              component={AppUserAccountProfile1}
            />
            <Route
              path="/user/account-profile/profile2"
              component={AppUserAccountProfile2}
            />
            <Route
              path="/user/account-profile/profile3"
              component={AppUserAccountProfile3}
            />
            ...
            <Route
              ...
              component={FrmComponentsDateTime}
            />

            <Route path="/forms/layouts/layouts" component={FrmLayoutLayout} />
            <Route
              path="/forms/layouts/multicolumnforms"
              component={FrmLayoutMultiColumnForms}
            />
            <Route
              path="/forms/layouts/actionbar"
              component={FrmLayoutActionBar}
            />
            <Route
              path="/forms/layouts/stickyactionbar"
              component={FrmLayoutStickyActionBar}
            />
            ...
            <Route
              ...
              component={AdvanceUIToggleButton}
            />
