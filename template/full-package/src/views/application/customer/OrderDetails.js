              ...
              <Grid container spacing={gridSpacing}>
                ...
                <Grid item xs={12}>
                  <Grid container spacing={2}>
                    ...
                    <Grid item xs={12}>
                      <Typography variant="body2">
                        lorem ipsum dolor sit connecter adieu siccing eliot, sed
                        do elusion tempore incident ut laborer et dolors magna
                        aliquot. Ut nim ad minim venin, quia nostrum
                        exercitation ullages labors nisi ut aliquot ex ea
                        commode consequent. Dui autre irusr dolor
                      </Typography>
                    </Grid>
                  </Grid>
                </Grid>
